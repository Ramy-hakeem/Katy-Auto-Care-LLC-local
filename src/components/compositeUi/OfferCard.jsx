...
function OfferCard({ bgWhite }) {
    return (
        <div className="shadow-xl rounded-lg relative
            ...
            <div className={`w-full h-[50%] p-3 rounded-b-lg  flex flex-col justify-around ${bgWhite ? "bg-white" : "bg-midnightBlack"}`}>
                <div className=" flex flex-col gap-3">
                    <h1 className={`font-medium
                        text-lg sm:text-xl md:text-2xl  
                        mt-2
                        pl-0 sm:pl-[15px] md:pl-[16px] 
                        ${bgWhite ? "text-[#024AA8]" : "text-white"}
                        `}>
                ...
                {bgWhite ?
                    (
                        <Link className="flex flex-col" to={"offers/id"}>
                            <Button className="flex items-center justify-center border border-s-4 border-pumpkin normal-case
