...
export default [
  ...
  },
  {
    path: `/offers`,
    name: "Offers Page",
    component: lazy(() => import("../pages/guest/Offers")),
    private: false,
    role: "guest",
    afterAuth: true,
  },
  {
    path: `offers/offer-details/1`,
    name: "Offer Details Page",
    component: lazy(() => import("../pages/guest/OfferDetails")),
    private: false,
    role: "guest",
    afterAuth: true,
  },
  {
    path: `about-us`,
    name: "About Us Page",
    component: lazy(() => import("../pages/guest/AboutUs")),
    private: false,
    role: "guest",
    afterAuth: true,
  },
