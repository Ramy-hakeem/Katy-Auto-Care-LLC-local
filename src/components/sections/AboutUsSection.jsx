  ...
  const aboutData = [
    {
      ...
      isThereDesc:
        "Experience the difference at Katy Auto Care LLC, where your vehicle’s well-being is our top priority.",
    },
  ];
  return (
    <div className=" py-10 bg-midnightBlack flex flex-col justify-around items-center my-20  w-full  ">
      <div className={`flex items-center justify-center gap-2  `}>
        <Image src={arrow} alt="pointer" className={`h-auto w-3 sm:w-5`} />
        <h1
      ...
      {aboutData.map((service, index) => (
        <ServiceCard
          ...
          desc={service.desc}
          list={service.list}
          isThereDesc={service.isThereDesc}
          index={index}
        />
      ))}
    </div>
